...
#ifndef _SP_DS_DINPUT8_TEMPLATE_H_
	#define _SP_DS_DINPUT8_TEMPLATE_H_
...
const char *SETTINGS_FILE = ".\\DS_dinput8_Mod.ini";
extern const char *SETTINGS_FILE_SUBSECTION;
const char *SETTINGS_FILE_SUBSECTION = "DS_dinput8_Mod";
...
#endif // _SP_DS_DINPUT8_TEMPLATE_H_